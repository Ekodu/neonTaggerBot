...
async def start(event):
  await event.reply("**🇦🇿EkoTaggerBot**\n ile Grubunuzdakı Nerdeyse Tüm Üyelere Etiket Ata bilirim \nKomutlar için =======> /help yazın**",
                    buttons=(
                   
		      [Button.url('ʙᴇɴɪ ɢʀᴜᴘᴀ ᴇᴋʟᴇ ➕', 'https://t.me/EkoTaggerBot?startgroup=a')],
                      [Button.url('sᴜᴘᴘᴏʀᴛ🛠👨‍💻', 'https://t.me/NeonSup')],
                      [Button.url('ʀᴇsᴍɪ ᴋᴀɴᴀʟ📣', 'https://t.me/EkoBlogs')],
		      [Button.url('sᴀʜɪʙɪᴍ👨🏻‍💻', 'https://t.me/Nevrozdu')],
                    ),
                    link_preview=False
                   )
@client.on(events.NewMessage(pattern="^/help$"))
async def help(event):
  helptext = "**🇦🇿EkoTaggerBot Komutları**\n\n**/tag <sebeb> - 5-li Etiket Atar**\n\n**/etag <sebeb> - Emoji ile etiketler**\n\n**/tektag sebeb - Üyeleri Tek Tek Etiketler**\n\n**/admins sebeb - Yöneticileri Tek Tek Tag Eder**\n\n**/start - botu başlatır**"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('ʙᴇɴɪ ɢʀᴜᴘᴀ ᴇᴋʟᴇ ➕', 'https://t.me/EkoTaggerBot?startgroup=a')],
                      [Button.url('sᴜᴘᴘᴏʀᴛ👨‍💻', 'https://t.me/NeonSup')],
                      [Button.url('ʀᴇsᴍɪ ᴋᴀɴᴀʟ🔖', 'https://t.me/EkoBlogs')],
		      [Button.url('sᴀʜᴜʙɪᴍ🧑‍🔧', 'https://t.me/Nevrozdu')],
                    ),
                    link_preview=False
                   )
...
async def help(event):
  helptext = "**Çok özellikleri Etiket Botu Bulmaya Çalışan Grub Sahibleri @EkoTaggerBot Size Göre:\n\n📌 5-li etiket\n📌 Emoji etiket\n📌 Tekli Etiket\n📌 Yalnız Yöneticileri etiketleme\n📌\n\n Böyle Çok özellikli @YarasaTaggerBot 'u grubunuza yönetici olarak ekleyip rahatlıkla üyelir , etiket ata bilirsiz **"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Botu Gruba Ekle➕', 'https://t.me/EkoTaggerBot?startgroup=a')],
                    ),
                    link_preview=False
                   )
  ...
  if mode == "text_on_cmd":
    ...
    async for usr in client.iter_participants(event.chat_id):
      ...
      if event.chat_id not in tekli_calisan:
        await event.respond("**Işlem Başarıyla Durduruldu\n\n**Buda sizin reklamınız ola bilir @NeonBots**❌****")
        return
      if usrnum == 1:
...
print(">> Bot çalıyor merak etme 🚀 @NeonSUP bilgi alabilirsin <<")
